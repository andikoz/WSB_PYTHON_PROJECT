...
def plot_initial(plot_df, symbol):
    fig = go.Figure(data=[go.Candlestick(x=plot_df['Open_Time'],
    ...
    fig.add_trace(go.Scatter(x=plot_df['Open_Time'],
...
def plot_results(plot_df, symbol, buys, sells):
    ...
    fig.update_xaxes(range=[plot_df['Open_Time'].iloc[0], plot_df['Open_Time'].iloc[-1]])
